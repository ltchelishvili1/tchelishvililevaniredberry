  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {laptops.map((laptop) => (
          <Route key={`234r${laptop.laptop.id}`} path={`/laptoplist/laptopid=${laptop.laptop.id}`} element={<Listitem positions={positions} brands={brands} teams={teams} TOKEN={TOKEN} id={laptop.laptop.id}
          />} />
        ))}
